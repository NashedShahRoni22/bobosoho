  ...
  return (
    <>
      {featuresData.map((feature, index) => (
        <section className={`${index % 2 === 0 && "bg-gray-200"}`}>
          <div
            key={index}
            className={`flex px-5 md:container md:mx-auto md:min-h-screen flex-col items-center justify-between gap-16 py-10 md:py-20 lg:flex-row`}
          >
