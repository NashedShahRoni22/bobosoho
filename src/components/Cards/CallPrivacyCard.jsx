export default function CallPrivacyCard({ feat }) {
  ...
  return (
    <div className="group relative col-span-12 overflow-hidden rounded-3xl bg-[#f7f7f8] p-6 hover:bg-transparent hover:text-white md:col-span-6 lg:col-span-4">
      <p className="text-2xl font-medium">{title}</p>
      <p className="mt-4 text-lg text-neutral-600 group-hover:text-white">
        {description}
      </p>
