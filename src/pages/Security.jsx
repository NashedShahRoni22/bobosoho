...
const Security = () => {
  ...
  return (
    <section className='mx-5 px-0 lg:px-64 md:container md:mx-auto my-20'>
        <div className='flex flex-col gap-5'>
            <h1 className='text-center text-2xl lg:text-4xl font-semibold text-blue-500'>Security of Bobosoho</h1>
